  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="w-full py-24 md:py-32 lg:py-40 bg-background text-white">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none">
                  ...
                  <span className="text-brand-red">Engaging Videos</span>
                </h1>
                <p className="mx-auto max-w-[700px] text-brand-grey md:text-xl mt-4">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-background/50 border-t border-brand-grey/20">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-brand-red/10">
                  <Video className="h-8 w-8 text-brand-red" />
                </div>
                <h3 className="text-xl font-bold text-white">Render Video</h3>
                <p className="text-sm text-brand-grey text-center">
